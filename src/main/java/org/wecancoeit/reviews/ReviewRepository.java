...
public class ReviewRepository {
    ...
    public ReviewRepository() {
        ...
        Review fredHammond = new Review(2L, "Please Don't Pass Me By", "Fred Hammond and Radical for Christ","/images/fh.jpg", "Worship", "I've been guilty of constantly having my hand out asking for things during my interactions with God. At times it's necessary to take a step back from everything that's on your plate and focus on Him. Please Don't Pass Me By is the perfect song for that journey into the Lord's presence.\n" +
                "\n" +
